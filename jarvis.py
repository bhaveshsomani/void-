...
p.speak("My name is jarvis how can i help you sir")
...
while True:
  ...
  if "browser" in i and not "chrome" in i and not "firfox" in i:
    p.speak(" There are 2 options chrome and firefox. Choose one please")
    j=input("Enter:")
    j=j.lower()
    ...
    p.speak("Prakash there are 2 options notepad and sublime. Choose one please")   
    j=input("Enter:")
    j.lower()
